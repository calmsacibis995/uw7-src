...
#ifndef lint
static char rcsid[] = "/proj/tcp/sco.ms/lcvs/usr/common/usr/src/cmd/net/bootpd/hash.c,v 6.5 1994/02/07 21:53:59 stevea Exp";
#endif
 ...
 * Modified to return -2 if malloc fails.   -aes
 */
