...
#define INET_LOG_FILE	"/tmp/inet.start"
...
extern int	modifyNetmask(ConfigFile_t *, char *, char *, char *, char *, char *);
extern int	modifyDefaultRouter(ConfigFile_t *, char *);
extern int	getNetmask(ConfigFile_t *, char *, char **, Class_t *);
