...
RPTSRCS  = adt_evtparse.c adt_mac.c adt_lvlin.c adt_lvlout.c adt_loadmap.c \
	  auditrptv4.c adt_optparse.c adt_getrec.c adt_print.c adt_cred.c
FLPSRCS  = auditfltrv4.c adt_getrec.c
RPTOBJS = $(RPTSRCS:.c=.o)
FLPOBJS = $(FLPSRCS:.c=.o)
MAINS = auditrptv4 auditfltrv4
...
install:	$(MAINS) $(INSDIR)
	$(INS) -f $(INSDIR) -m 0550 -u $(OWN) -g $(GRP) auditrptv4
	$(INS) -f $(INSDIR) -m 0550 -u $(OWN) -g $(GRP) auditfltrv4
...
partslist:
	@echo auditrptv4.mk $(SRCDIR) $(RPTSRCS) $(FLPSRCS) | tr ' ' '\012' | sort
