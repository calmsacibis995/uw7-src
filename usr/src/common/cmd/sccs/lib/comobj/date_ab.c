#ident	"@(#)sccs:lib/comobj/date_ab.c	6.8"
# include	<sys/types.h>
# include	<macros.h>
# include	<time.h>
...
/*
	...
	It also presumes years <70 to be in the 21st century
	(although the number of seconds since the epoch which
	can fit in a 32-bit value maxes out sometime in 2038).
