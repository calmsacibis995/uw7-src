...
.C .C~ .Y .Y~ .L .L~ .asm .asm~ .src .src~ .inc .inc~ .a",
...
/* SINGLE SUFFIX RULES */
	...
	".C~:",
        ...
        ".asm~:",
                "\t$(GET) $(GFLAGS) $<",
                "\t$(MASM) $(MASMFLAGS) -o$*.o $*.asm",
                "\t$(LD) $*.o $(LDFLAGS) -o $@",
                "\t-rm -f $*.asm $*.o",
        ".l:",
                "\t$(LEX) $(LFLAGS) $<",
                "\tmv lex.yy.c $*.c",
                "\t$(CC) $(CFLAGS) $*.c $(LDFLAGS) -o $@ -ll",
                "\t-rm -f $*.c",
        ".l~:",
                "\t$(GET) $(GFLAGS) $<",
                "\t$(LEX) $(LFLAGS) $*.l",
        ...
        ".y:",
                "\t$(YACC) $(YFLAGS) $<",
                "\t$(CC) $(CFLAGS) y.tab.c $(LDFLAGS) -o $@ -ll -ly",
                "\t-rm y.tab.c",
        ".y~:",
                "\t$(GET) $(GFLAGS) $<",
                "\t$(YACC) $(YFLAGS) $*.y",
