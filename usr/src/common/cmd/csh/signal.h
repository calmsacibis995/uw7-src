...
#ident	"@(#)csh:common/cmd/csh/signal.h	1.2.8.1"
#ident  "$Header$"
...
/*
 * Workaround to allow csh to be linked statically.  Currently, signal() is
 * the only libc routine with which we conflict; others have weak bindings.
 */

#define signal	mysignal	/* workaround for libc name conflict */
