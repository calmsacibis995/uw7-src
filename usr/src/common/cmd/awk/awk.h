...
#define	RECSIZE	(5 * 1024)	/* sets limit on records, fields, etc., etc. */


/*
 * This is done to prevent redefinition of our own definitions for FS with
 * those defined in the system's header files.
 */
#undef FS
...
extern	Node	*makearr();
extern	int	is2number(uchar *, Cell *);
