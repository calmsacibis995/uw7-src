#ident	"@(#)OSRcmds:csh/alloc.c	1.1"
#ident	"%c%"
/*
 * Modification History
 *
 * L000		17 Feb 1994	scol!gregw
 *	- renamed malloc to Malloc and free to Free to avoid clash with libc.
 */

/*
 *	@(#) alloc.c 1.1 88/03/29 csh:alloc.c
 */
/*	@(#)alloc.c 25.1 94/02/18 
