#ident	"@(#)OSRcmds:csh/sh.vmwait.c	1.1"
/*
 *	@(#) sh.vmwait.c 25.1 94/02/18 
 *
...
/* #ident	"@(#)csh:sh.vmwait.c	1.2" */
#pragma comment(exestr, "@(#) sh.vmwait.c 25.1 94/02/18 ")
/*
...
/*
 *	@(#) sh.vmwait.c 1.1 88/03/29 csh:sh.vmwait.c
 */
/*	@(#)sh.vmwait.c	2.1	SCCS id keyword	*/
