#ident	"@(#)OSRcmds:csh/sh.h	1.1"
#pragma comment(exestr, "@(#) sh.h 25.1 94/02/18 ")
/*
...
/*
 *	@(#) sh.h 1.1 88/03/29 csh:sh.h
 */
/*
 *	MODIFICATION HISTORY
 *	S000	10 July 1989	sco!hoeshuen
 *	- include <dirent.h> for opendir(), readdir() and closedir().
 *	L001	19nov90		scol!hughd
 *	- dispose of compiler warnings: reset() pass val 1 to longjmp()
 *	L002	17feb94		scol!gregw
 ...
 */
extern	char	*mesg[];	/* M000 added extern */

extern	struct	biltins {	/* M000 added extern */
	char	*bname;
	int	(*bfunct)();
	short	minargs, maxargs;
} bfunc[];

extern	struct srch {		/* M000 added extern */
	char	*s_name;
	short	s_value;
} srchn[];
...
#define	reset()		longjmp(reslab, 1)			/* L001 */
