#ident	"@(#)OSRcmds:sh/fault.c	1.1"
/*
 *	@(#) fault.c 1.4 88/11/11 
 *
...
/* #ident	"@(#)sh:fault.c	1.4" */
#pragma comment(exestr, "@(#) fault.c 1.4 88/11/11 ")
/*
 * UNIX shell
 */
