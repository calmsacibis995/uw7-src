#ident	"@(#)OSRcmds:ksh/include/edit.h	1.1"
#pragma comment(exestr, "@(#) edit.h 25.3 93/01/20 ")
/*
 ...
 *
 *	L000	scol!markhe	14 Jan 1993
 *	- corrected definition of message variable e_runvi
 */
