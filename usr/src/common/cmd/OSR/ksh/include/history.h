#ident	"@(#)OSRcmds:ksh/include/history.h	1.1"
#pragma comment(exestr, "@(#) history.h 25.3 93/01/20 ")
/*
 ...
 *	- corrected type of message variables
 */
...
extern MSG		hist_fname;				/* L000 */
extern MSG		e_history;				/* L000 */
