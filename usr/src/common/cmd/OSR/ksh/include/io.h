#ident	"@(#)OSRcmds:ksh/include/io.h	1.1"
#pragma comment(exestr, "@(#) io.h 25.3 93/01/20 ")
/*
...
extern MSG	e_create;				/* L000 begin */
extern MSG	e_file;
extern MSG	e_open;
extern MSG	e_pipe;
extern MSG	e_flimit;
extern MSG	e_fexists;
extern MSG	e_unknown;
extern MSG	e_endoffile;
extern MSG	e_devnull;
extern MSG	e_profile;
extern MSG	e_suidprofile;
extern MSG	e_sysprofile;
extern MSG	e_devfdNN;
#ifdef SUID_EXEC
    extern MSG	e_suidexec;				/* L000 end */
#endif /* SUID_EXEC */
#endif /* KSHELL */
