#ident	"@(#)OSRcmds:ksh/include/stak.h	1.1"
#pragma comment(exestr, "@(#) stak.h 25.3 93/09/10 ")
/*
 ...
 *	- added prototype for stakkludge() - see sh/stak.c
 *	L001	scol!ashleyb	08 Sep 93
 *	- changed prototype for stakkludge() so that USL compiler does
 *	  not fail.
 */
...
#define STAK_SMALL	1	/* argument to stakcreate */
	...
	extern void	stakkludge __ARGS((char *));	/* L000 */ /* L001 */
