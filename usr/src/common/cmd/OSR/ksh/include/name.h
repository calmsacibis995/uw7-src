#ident	"@(#)OSRcmds:ksh/include/name.h	1.1"
#pragma comment(exestr, "@(#) name.h 25.3 93/01/20 ")
/*
...
extern MSG	e_synbad;				/* L000 begin */
extern MSG	e_subscript;
extern MSG	e_number;
extern MSG	e_nullset;
extern MSG	e_notset;
extern MSG	e_readonly;
extern MSG	e_restricted;
extern MSG	e_ident;
extern MSG	e_intbase;
extern MSG	e_format;
extern MSG	e_aliname;				/* L000 end */
