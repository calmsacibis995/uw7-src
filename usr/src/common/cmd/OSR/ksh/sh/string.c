#ident	"@(#)OSRcmds:ksh/sh/string.c	1.1"
#pragma comment(exestr, "@(#) string.c 26.1 95/06/28 ")
/*
 ...
 *
 *	L001 scol!anthonys	4 Jul 94
 *	- new function to support symbolic mode arguments for umask
 *	L002 scol!markhe	16 Jun 95
 *	- changed functionality of '=' for umask.
 *	  POSIX.2/XPG4 states '=' without a 'who' sets the umask independent
