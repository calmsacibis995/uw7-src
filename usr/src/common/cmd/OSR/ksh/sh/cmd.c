#ident	"@(#)OSRcmds:ksh/sh/cmd.c	1.1"
#pragma comment(exestr, "@(#) cmd.c 25.3 93/01/20 ")
/*
 ...
 *	- the list operators || and && have equal precedence, even when
 *	  POSIX is defined (an earlier draft the original code was based
 *	  on gave && higher precedence)
 */
