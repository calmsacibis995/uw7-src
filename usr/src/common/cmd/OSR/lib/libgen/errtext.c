#ident	"@(#)OSRcmds:lib/libgen/errtext.c	1.1"
/*
 *	@(#) errtext.c 20.1 94/12/04 
 *
...
/* #ident	"@(#)libgen:errtext.c	1.3" */
#pragma comment(exestr, "@(#) errtext.c 20.1 94/12/04 ")
