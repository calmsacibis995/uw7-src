...
#ident	"@(#)sh:common/cmd/sh/msg.c	1.15.21.6"
#ident "$Header$"
/*
 *	UNIX shell
 */
...
const char killuse[]		= "kill [ -s sig | -sig ] id ... | -l [status]";
const char killuseid[]		= ":1188";
...
const char flimit[]		= "too many open files";
const char flimitid[]		= ":539";
const char badumask[]		= "Bad umask";
const char badumaskid[]		= ":1189";
const char readuse[]		= "read [ -r ] name...";
const char readuseid[]		= ":1190";
