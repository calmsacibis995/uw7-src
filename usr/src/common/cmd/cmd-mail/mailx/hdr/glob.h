...
#ident "@(#)glob.h	1.22 'attmail mail(1) command'"
...
extern const char	*editfile;	/* Name of file being edited */
...
extern MAILSTREAM	*itf;		/* Input temp file buffer */
...
extern char		*lockfname;	/* named used for locking in /var/mail */
extern char		maildir[];	/* directory for mail files */
extern char		mailname[];	/* Name of /var/mail system mailbox */
extern char		*remotehost;	/* Name of remote folder system */
...
extern char		mm_cmd_default[];	/* default metamail command */
...
extern int		tflag;		/* -t use To: fields to get recipients */
extern uid_t		uid;		/* The invoker's user id */
extern struct utimbuf	*utimep;	/* pointer to time stamp for mailbox */
extern struct var	*variables[];	/* Pointer to active var list */
extern char		*version;	/* mailx version (see comm.mk) */
