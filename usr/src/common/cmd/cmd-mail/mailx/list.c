...
first(f, m)
{
	register int mesg;
	register struct message *mp;
	/* if copy is put in .mailrc then it comes in here
	 * with no messages, since the mailbox has not been
	 * opened yet. This stops mailx from core dumping
	 */
