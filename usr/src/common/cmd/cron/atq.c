...
#ident	"@(#)cron:common/cmd/cron/atq.c	1.7.10.4"
...
char **argv;
{
	...
	if ((pr.pw_name = strdup(pp->pw_name)) == NULL)
...
char *filename;
{
	...
	sprintf(date,"%3s %2d, %4d %02d:%02d",mthnames[unpackeddate->tm_mon],
	    unpackeddate->tm_mday,(1900 + unpackeddate->tm_year),
