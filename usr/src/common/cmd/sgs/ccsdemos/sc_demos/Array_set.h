/*ident	"@(#)ccsdemos:sc_demos/Array_set.h	1.2" */

/*
 *  Array_set - Block-based implementation of parameterized Set class.
 *
 *  This implementation is based on Array Algorithm functions.
