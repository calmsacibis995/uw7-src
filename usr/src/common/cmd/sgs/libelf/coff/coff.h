 ...
 *	c_note		Function to add .note section if desired
 *
 *	c_opt(), c_rel() and c_note() failures must return OK_NO
 *	and set the error number. 
 *	A delayed failure may appear through the
