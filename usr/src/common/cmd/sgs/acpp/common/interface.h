#ident	"@(#)acpp:common/interface.h	1.18"
#ifndef _INTERFACE_H
#define _INTERFACE_H
...
typedef struct ext_token {
	Token tk;
	struct ext_token *next_ext_token;
} Ext_Token;
...
# define C_NotGreaterThan ( 		  C_CONDEXPR |	C_OP  |			NX(0x16))
# define C_GreaterEqual	( 		  C_CONDEXPR |	C_OP  |			NX(0x17))
# define C_NotGreaterEqual ( 		  C_CONDEXPR |	C_OP  |			NX(0x18))
# define C_LessThan	( 		  C_CONDEXPR |	C_OP  |			NX(0x19))
# define C_NotLessThan	( 		  C_CONDEXPR |	C_OP  |			NX(0x1A))
# define C_LessEqual	( 		  C_CONDEXPR |	C_OP  |			NX(0x1B))
# define C_NotLessEqual	( 		  C_CONDEXPR |	C_OP  |			NX(0x1C))
# define C_LessGreater	( 		  C_CONDEXPR |	C_OP  |			NX(0x1D))
# define C_NotLessGreater ( 		  C_CONDEXPR |	C_OP  |			NX(0x1E))
# define C_LessGreaterEqual ( 		  C_CONDEXPR |	C_OP  |			NX(0x1F))
# define C_NotLessGreaterEqual ( 	  C_CONDEXPR |	C_OP  |			NX(0x20))
# define C_LeftShift	( 		  C_CONDEXPR |	C_OP  |			NX(0x21))
# define C_RightShift	( 		  C_CONDEXPR |	C_OP  |			NX(0x22))
# define C_Plus		( 		  C_CONDEXPR |	C_OP  |			NX(0x23))
# define C_Minus	( 		  C_CONDEXPR |	C_OP  |			NX(0x24))
# define C_Mult		( 		  C_CONDEXPR |	C_OP  |			NX(0x25))
# define C_Div		( 		  C_CONDEXPR |	C_OP  |			NX(0x26))
# define C_Mod		( 		  C_CONDEXPR |	C_OP  |			NX(0x27))
# define C_UnaryPlus	( C_INTERNAL	| C_CONDEXPR |				NX(0x28))
# define C_UnaryMinus	( C_INTERNAL	| C_CONDEXPR |				NX(0x29))
# define C_Complement	( 		  C_CONDEXPR |	C_OP  |			NX(0x2A))
# define C_Not		( 		  C_CONDEXPR |	C_OP  |			NX(0x2B))
# define C_LParen	( 		  C_CONDEXPR |	C_OP  |			NX(0x2C))
# define C_Operand	( C_INTERNAL	| C_CONDEXPR |				NX(0x2D))
# define C_Sharp 	( 				C_OP  |	C_INEXPAND |	NX(0x2E))
# define C_LBracket	(				C_OP  |			NX(0x2F))
# define C_RBracket	(				C_OP  | 		NX(0x30))
# define C_LBrace	(				C_OP  | 		NX(0x31))
# define C_RBrace	(				C_OP  | 		NX(0x32))
# define C_Arrow	(				C_OP  | 		NX(0x33))
# define C_Assign	(				C_OP  | 		NX(0x34))
# define C_MultAssign	(				C_OP  | 		NX(0x35))
# define C_DivAssign	(				C_OP  | 		NX(0x36))
# define C_ModAssign	(				C_OP  | 		NX(0x37))
# define C_PlusAssign	(				C_OP  | 		NX(0x38))
# define C_MinusAssign	(				C_OP  | 		NX(0x39))
# define C_LeftAssign	(				C_OP  | 		NX(0x3A))
# define C_RightAssign	(				C_OP  | 		NX(0x3B))
# define C_ANDAssign	(				C_OP  | 		NX(0x3C))
# define C_XORAssign	(				C_OP  | 		NX(0x3D))
# define C_ORAssign	(				C_OP  | 		NX(0x3E))
# define C_SemiColon	(				C_OP  | 		NX(0x3F))
# define C_Ellipsis	(				C_OP  | 		NX(0x40))
# define C_Dot		(				C_OP  | 		NX(0x41))
# define C_Increment	(				C_OP  | 		NX(0x42))
# define C_Decrement	(				C_OP  | 		NX(0x43))
	/* c++ tokens start here */

# define C_ArrowStar	(				C_OP  |			NX(0x44))
# define C_DotStar	(				C_OP  |			NX(0x45))
# define C_Scope	( 				C_OP  |			NX(0x46))
	/* end c++ tokens */
# define C_Paste	( 				C_OP  |	C_INSUBST |	NX(0x47))
# define C_Formal	( C_INTERNAL	| C_FORMAL   |		C_INSUBST |	NX(0x48))
# define C_StrFormal	( C_INTERNAL	| C_FORMAL   |		C_INSUBST |	NX(0x49))
# define C_MergeFormal	( C_INTERNAL	| C_FORMAL   |				NX(0x4A))
# define C_UnexpFormal	( C_INTERNAL	| C_FORMAL   |		C_INSUBST |	NX(0x4B))
# define C_BadInput	( 							NX(0x4C))
# define C_Invalid	( 							NX(0x4D))
# define C_Goofy	( C_INTERNAL	|					NX(0x4E))
# define C_MacroName	( C_INTERNAL	|					NX(0x4F))
# define C_Manifest	( C_INTERNAL	|					NX(0x50))
# define C_Marker	( C_INTERNAL	|			C_INEXPAND |	NX(0x51))

#define PP_CURLINE()	bf_curline()
#define PP_CURSEQNO()	bf_curseqno()
...
extern	unsigned int	bf_curseqno( void  );

extern	char *	fl_curname(	void	);
extern  char *  fl_incdir_name(	void	);
