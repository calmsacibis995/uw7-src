...
#define M__STDCVERSION	(1<<4)		/* name is `__STDC_VERSION__' */
#define M__DATE		(1<<5)		/* name is `__DATE__'	*/
#define M__TIME		(1<<6)		/* name is `__TIME__'	*/
#define M_DEFINED	(1<<7)		/* name is `defined'	*/
#define M_PREDEFINED	(M__LINE|M__FILE|M__STDC|M__STDCVERSION|M__DATE|M__TIME)
#define M_CONSTRAINED	(M__LINE|M__FILE|M__STDC|M__STDCVERSION|M__DATE|M__TIME|M_DEFINED)
#define M_MANIFEST	(1<<8)		/* macro is a manifest constant:
