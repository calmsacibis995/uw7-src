#ident	"@(#)sgs-inc:common/ldfcn.h	2.5.4.5"
...
extern int ldlitem(LDFILE *, unsigned short, LINENO *);
extern int ldlread(LDFILE *, long, unsigned short, LINENO *);
...
extern int ldshread(LDFILE *, unsigned short, SCNHDR *);
