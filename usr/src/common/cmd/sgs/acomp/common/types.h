#ident	"@(#)acomp:common/types.h	52.27"
/* types.h */
...
#define	TY_LLONG	15	/* plain long-long */
#define	TY_ULLONG	16	/* unsigned long-long */
#define	TY_SLLONG	17	/* signed long-long */
...
typedef struct {
    ...
    ty_typetab ts_dbscope;	/* scope number for debugging info entry */
...
#endif
#define	TY_DBSCOPE(t) (TT((t),ts_generic)->ts_dbscope)
