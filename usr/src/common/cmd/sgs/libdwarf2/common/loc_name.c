#ident	"@(#)libdwarf2:common/loc_name.c	1.2"

#include "dwarf2.h"
#include "libdwarf2.h"
#include "Table.h"

static Table location_op_names[] =
{
	...
	{ DW_OP_SCO_reg_pair,	"DW_OP_SCO_reg_pair" },
	{ DW_OP_hi_user,	"DW_OP_hi_user" },
	0
};

const char *
dwarf2_location_op_name(unsigned int op)
{
	return get_name(location_op_names, op);
}
