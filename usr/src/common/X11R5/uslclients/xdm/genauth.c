...
int	len;
{
	...
	Debug("ITIMER_REAL GenerateAuthorization\n");
	...
	Debug("NOT ITIMER_REAL GenerateAuthorization\n");
	ldata[0] = time ((long *) 0);
	ldata[1] = getpid ();
    }
#endif
	...
	Debug("HASXDMAUTH GenerateAuthorization\n");
	...
	Debug("NOT HASXDMAUTH GenerateAuthorization\n");
