...
#define Xfree(ptr) (void) free((ptr))
...
#ifdef SVR4 /* QOS:marcel - allow for a variable buffer size */
#define VARIABLE_BUFSIZE
#endif
...
/* QOS:marcel - END new prototypes */

extern void _XWaitForReadable(
