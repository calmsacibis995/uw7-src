...
#endif
{
    ...
    massagedPath = /* ALLOCATE_LOCAL(bytesAllocd); PERF */
	ALLOCATE_MAYBE(bytesAllocd,localBuf,localBufInUse);	/* PERF */
	...
	if (bytesLeft < 8) {
		...
		/* DEALLOCATE_LOCAL(massagedPath); PERF */
