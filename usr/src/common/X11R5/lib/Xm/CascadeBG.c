#pragma ident	"@(#)m1.2libs:Xm/CascadeBG.c	1.9"
/* 
...
#endif
        /* ShadowThickness is hardcoded to 2 for 1.x compatibility
         * because _XmDrawArrow() of CDE Motif supports three ShadowThickness:
         * 0, 1, 2 while Motif 1.x supports two of them: 0, 2.
         */
