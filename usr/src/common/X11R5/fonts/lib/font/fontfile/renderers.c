#ident	"@(#)r5fonts:lib/font/fontfile/renderers.c	1.4"
...
#endif
/*
 * We can either have MIT Type1 or proprietary Adobe Type1 as of 4/5/93
 * Since we use Adobe's proprietary Type1 rendering, don't use the one from 
 * MIT. 6/2/93 Registration methods for Type1|type1 as well as for Speedo
 * are now called from the fontserver in server/difs/initfonts.c
 */
#if 0
