#ident	"@(#)r5fonts:lib/font/Type1/objects.c	1.1"
...
*/
	...
	/*
	  * PPc:md - changed this from 'while (GimeSpace()) { ; }'
	  * to the below because the SVR4.2 optimizer crashed after
	  * generating a 'warning: end-of-loop code not reached' message
	  */
	while (1) {
	    if (!GimeSpace())
	      break;
