    ...
    char       *expanded_name;	/* return */
{
    ...
    *(server_ptr++) = '\0';
    ...
    tmpservername = strdup(server_name);
...
if ( LocalNamed == 0 ){	/* not a local, i.e. named-pipe connection */
#endif /* SVR4 */	/* go ahead and set up a network socket */
#ifndef SVR4
	{
#endif /* SVR4 */
	    char	*sp = serverbuf;
...
#undef add_to_iov
    ...
    return;
#ident	"@(#)r5fonts:lib/fs/FSConnServ.c	1.6"
}
