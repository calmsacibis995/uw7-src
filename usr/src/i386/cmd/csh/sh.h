...
#ident	"@(#)csh:i386/cmd/csh/sh.h	1.7.6.7"
#ident  "$Header$"
...
#include "sh.local.h"
#include "sh.char.h"
#include "sh.msg.h"	/* internationalization of message	*/
...
bool	globsafe;			/* is it safe to call tglob? */
