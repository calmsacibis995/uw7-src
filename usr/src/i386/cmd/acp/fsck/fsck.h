...
#ident	"@(#)acp:i386/cmd/acp/fsck/fsck.h	1.2.1.3"
...
#define XXSTEPSIZE	9	/* default step for freelist spacing */
#define XXCYLSIZE	400	/* default cyl size for spacing */
#define XXMAXCYL	500	/* maximum cylinder size */
...
struct bufarea {
	...
	union {
		...
		struct xxfilsys b_fs;		/* super block */
