#ifndef _NET_SOCKETVAR_H	/* wrapper symbol for kernel use */
#define _NET_SOCKETVAR_H	/* subject to change without notice */

#ident	"@(#)socketvar.h	1.2"
#ident	"$Header$"
...
#define	SS_PRIV			0x400	/* privileged for broadcast, raw... */

#define	SS_NOGHOST		0x20000	/* TCP only - don't ghost this inp */
#define	SS_NOINPUT		0x40000	/* TCP only - don't find this one */
#define	SS_ZOMBIE		0x80000	/* TCP only - reap this inp */
#define	SS_NODELETE		0x100000 /* TCP only - slow timer using inp */
#define	SS_IGNERR		0x200000 /* ignore T_UDERROR_INDs when set */
#define	SS_SETSND		0x400000 /* set send buffer size */
#define	SS_SETRCV		0x800000 /* set receive buffer size */
