#ident	"@(#)kern-i386:util/kdb/kdb_util/tbls.c	1.5.2.1"
/* @(#)tables.c	10.2 */
...
/*  [C4]  */	INVALID,		INVALID,		INVALID,		{"cmpxchg8",TERM,M,0},
...
/* [8,0] */	{"",op80,TERM,0},	{"",op81,TERM,0},	INVALID,		{"",op83,TERM,0},
...
/* [F,0] */	{"lock ",TERM,PREFIX,0},	INVALID,	{"repnz ",TERM,PREFIX,0},	{"repz ",TERM,PREFIX,0},
