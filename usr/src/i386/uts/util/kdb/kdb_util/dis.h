#ifndef _UTIL_KDB_KDB_DIS_H	/* wrapper symbol for kernel use */
#define _UTIL_KDB_KDB_DIS_H	/* subject to change without notice */

#ident	"@(#)kern-i386:util/kdb/kdb_util/dis.h	1.6"
#ident	"$Header$"
