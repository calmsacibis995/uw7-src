...
DRVDIR = ../ni1.cf
DRV = $(DRVDIR)/Driver.o
Q931DRV = ../drv.diq931/Driver.ni1.o 
...
# We need an EtdP driver, so do it with ni1

install: all
	(cd $(DRVDIR); $(IDINSTALL) -R$(CONF) -M ni1)
	(cd $(DRVDIR); $(IDINSTALL) -R$(CONF) -M EtdP)
...
clobber: clean
	...
	(cd $(DRVDIR); $(IDINSTALL) -R$(CONF) -d -e ni1)
	(cd $(DRVDIR); $(IDINSTALL) -R$(CONF) -d -e EtdP)
