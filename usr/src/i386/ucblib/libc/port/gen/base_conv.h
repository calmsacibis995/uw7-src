...
#ident	"@(#)ucb:i386/ucblib/libc/port/gen/base_conv.h	1.3"
#ident	"$Header$"
...
/* The following define is appropriate for compilers that lay out the 
   format for the 3 longs in extended format in reverse order - which is the
   current implementation - the following define should be commented out
   otherwise - it is the only item in this file that is "machine-specific".
 */
#define _FP_STRUCT_REVERSE
