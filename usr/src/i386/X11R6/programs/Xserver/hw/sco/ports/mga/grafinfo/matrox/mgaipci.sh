...
ADAPTOR_NAME="Matrox Impression"
VENDOR_ID=0x102B
DEVICE_ID=0x0D10
PREFIX=mgaipci_
MODEL=MGAIPCI_
...
if [ -d /usr/X11R6.1 ]
then
        GRAF_TMPL=/usr/X11R6.1/lib/grafinfo/matrox/mgaipci.tmpl
        GRAF_DIR=/usr/X11R6.1/lib/grafinfo/matrox
        AOF_DIR=/usr/X11R6.1/lib/vidconf/AOF/ID/matrox
        AOF_TMPL=/usr/X11R6.1/lib/vidconf/AOF/TMPL/matrox/mgaipci
        PATH=/usr/X11R6.1/lib/vidconf/scripts:$PATH
else
        GRAF_TMPL=/usr/lib/grafinfo/matrox/mgaipci.tmpl
        GRAF_DIR=/usr/lib/grafinfo/matrox
        AOF_DIR=/usr/lib/vidconf/AOF/ID/matrox
        AOF_TMPL=/usr/lib/vidconf/AOF/TMPL/matrox/mgaipci
