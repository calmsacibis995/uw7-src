...
if [ -d /usr/X11R6.1 ]
then
        TEMPLATE=/usr/X11R6.1/lib/grafinfo/numbernine/imagine128.tmpl
        GRAFINFO=/usr/X11R6.1/lib/grafinfo/numbernine/imagine128.xgi
        PATH=/usr/X11R6.1/lib/vidconf/scripts:$PATH
else
        TEMPLATE=/usr/lib/grafinfo/numbernine/imagine128.tmpl
        GRAFINFO=/usr/lib/grafinfo/numbernine/imagine128.xgi
