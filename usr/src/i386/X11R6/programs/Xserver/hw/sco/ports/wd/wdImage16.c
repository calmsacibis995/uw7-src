 ...
 *
 *	S000	Tue Mar 16 09:46:25 PST 1993	buckm@sco.com
 *		Created.
 */
...
/*
 * wdDrawImage16() - Draw pixels in a rectangular area of a window.
 ...
 */
void 
wdDrawImage16(pbox, image, stride, alu, planemask, pDraw)
	BoxPtr pbox;
	unsigned char *image;
	unsigned int stride;
	unsigned char alu;
