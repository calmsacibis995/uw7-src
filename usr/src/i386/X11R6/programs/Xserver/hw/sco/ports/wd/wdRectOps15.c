...
/*
 * wdRectOps15.c
 *               wd 15-bit rectangular drawing ops.
 */
/*
 *
 *      SCO MODIFICATION HISTORY
 *
 *	S000	Tue Mar 16 18:20:51 PST 1993	buckm
 *		Created.
...
/*
 * wdCopyRect15() - Copy a rectangle from screen to screen.
	...
	DrawablePtr pDraw)
{
	...
	if( ((planemask ^ (planemask >> 8)) & 0x7F) == 0 )
	{   /* just copy */
...
/*
 * wdDrawSolidRects15() - Draw solid-color rectangles.
...
#ifdef DEBUG_PRINT
	ErrorF("wdDrawSolidRects15(pbox=%x, nbox=%d, ", pbox,nbox);
