/*
 *	@(#)ctOnboard.c	11.1	10/22/97	12:10:50
 *	@(#) ctOnboard.c 12.1 95/05/09 
 *
...
ScreenPtr pScreen;
{
	...
	default:
		...
		/* FALL THRU */
	case 0x00:
		heap->size = 512 * 1024;	/* 512Kb 16-bit Data Path */
		break;
	case 0x01:
		heap->size = 1 * 1024 * 1024;	/* 1Mb 32-bit Data Path */
		break;
	case 0x02:
		heap->size = 2 * 1024 * 1024;	/* 2Mb 32-bit Data Path */
		break;
	}
