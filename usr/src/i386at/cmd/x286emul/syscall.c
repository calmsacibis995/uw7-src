...
#ident	"@(#)x286emul:syscall.c	1.2.1.1"
...
/*
 * This is done to prevent redefinition of our own definitions for CS,
 * DS, ES with those defined in the system's header files.
 */
#undef CS
#undef DS
#undef ES
...
struct dummy { unsigned short n, argoff, dummy; };
