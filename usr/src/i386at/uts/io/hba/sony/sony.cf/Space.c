#ident	"@(#)kern-i386at:io/hba/sony/sony.cf/Space.c	1.8.1.1"
#ident	"$Header$"
...
#ifdef  SONY_CPUBIND
#define SONY_VER	HBA_UW21_IDATA | HBA_IDATA_EXT
struct	hba_ext_info sony_extinfo = {
	0, SONY_CPUBIND
};
#else
#define SONY_VER	HBA_UW21_IDATA
#endif

struct	hba_idata_v5	_sonyidata[] = {
