...
#ident	"@(#)kern-i386at:io/i8237A.h	1.8"
#ident	"$Header$"
...
extern unsigned char	d37A_get_best_mode(struct dma_cb *);
extern void		d37A_intr(int);
extern void		d37A_init(void);
extern int		d37A_prog_chan(struct dma_cb *, int);
extern void		d37A_dma_enable(int);
extern int		d37A_dma_swsetup(struct dma_cb *, int);
extern void		d37A_dma_swstart(int);
extern void		d37A_dma_stop(int);
extern void		d37A_get_chan_stat(struct dma_stat *, int);
extern int		d37A_cascade(int);
extern void		d37A_physreq(int, int, struct physreq *);
