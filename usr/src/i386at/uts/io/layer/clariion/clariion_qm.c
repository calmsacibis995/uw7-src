#ident	"@(#)kern-pdi:io/layer/clariion/clariion_qm.c	1.1"
 ...
 * position of each access so that next accesses via clariion_qm_next_and_rotate()
...
/*
 * void
 * clariion_qm_initialize  ( clariion_qm_anchor_t *anchor_ptr, ulong_t link_offset )
 *
 * Calling/Exit State
 *	None.
 */
...
/*
 * void
 * clariion_qm_move  ( clariion_qm_anchor_t *from_anchor_ptr, clariion_qm_anchor_t *to_anchor_ptr )
...
/*
 * boolean_t
 * clariion_qm_is_member( clariion_qm_anchor_t *anchor_ptr, void *entry_ptr )
...
clariion_qm_is_member( clariion_qm_anchor_t *anchor_ptr, void *entry_ptr )
{
	...
	for ( q_entry_ptr = CLARIION_QM_HEAD( anchor_ptr );
		  q_entry_ptr != NULL;
		  q_entry_ptr = CLARIION_QM_NEXT( anchor_ptr, q_entry_ptr ) ) {
...
/*
 * void
 * clariion_qm_add_head ( clariion_qm_anchor_t *anchor_ptr, void *entry_ptr )
...
clariion_qm_add_head ( clariion_qm_anchor_t *anchor_ptr, void * entry_ptr )
{
	...
	clariion_qm_link_t * next_links_ptr;
	clariion_qm_link_t * new_links_ptr;
	...
	if( anchor_ptr->links.next == NULL ) {
		...
		next_links_ptr =
			CLARIION_QM_ENTRY_PTR_TO_LINK_PTR( anchor_ptr, anchor_ptr->links.next );
    }
	new_links_ptr = CLARIION_QM_ENTRY_PTR_TO_LINK_PTR( anchor_ptr, entry_ptr );
...
/*
 * void
 * clariion_qm_add_tail ( clariion_qm_anchor_t *anchor_ptr, void *entry_ptr )
...
clariion_qm_add_tail ( clariion_qm_anchor_t *anchor_ptr, void * entry_ptr )
{
	clariion_qm_link_t * prev_links_ptr;
	clariion_qm_link_t * new_links_ptr;
	...
	if( anchor_ptr->links.next == NULL ) {
		...
		prev_links_ptr =
        CLARIION_QM_ENTRY_PTR_TO_LINK_PTR( anchor_ptr, anchor_ptr->links.prev );
	}
...
/*
 * void
 * clariion_qm_next_and_rotate ( clariion_qm_anchor_t *anchor_ptr)
...
clariion_qm_next_and_rotate( clariion_qm_anchor_t *anchor_ptr)
{
	clariion_qm_link_t * return_value;
	clariion_qm_link_t * next_links_ptr;

	return_value = anchor_ptr->rotor;
    if (return_value != NULL){
    	next_links_ptr = CLARIION_QM_ENTRY_PTR_TO_LINK_PTR( anchor_ptr, return_value );
...
/*
 * void *
 * clariion_qm_remove_head ( clariion_qm_anchor_t *anchor_ptr )
...
clariion_qm_remove_head ( clariion_qm_anchor_t *anchor_ptr )
{
	clariion_qm_link_t * removed_links_ptr;
	clariion_qm_link_t * next_links_ptr;
	clariion_qm_link_t * return_value;
	...
	if( return_value != NULL ) {
		anchor_ptr->size -= 1;
		removed_links_ptr = CLARIION_QM_ENTRY_PTR_TO_LINK_PTR( 
								anchor_ptr, return_value );
		if( removed_links_ptr->next == NULL ) {
			next_links_ptr = &anchor_ptr->links;
		}
		else {
			next_links_ptr = CLARIION_QM_ENTRY_PTR_TO_LINK_PTR(
...
/*
 * void *
 * clariion_qm_remove_tail ( clariion_qm_anchor_t *anchor_ptr )
...
clariion_qm_remove_tail ( clariion_qm_anchor_t *anchor_ptr )
{
	...
	if( return_value != NULL ) {
		...
		if( removed_links_ptr->prev == NULL ) {
			...
			prev_links_ptr = CLARIION_QM_ENTRY_PTR_TO_LINK_PTR(
...
/*
 * void
 * clariion_qm_remove ( clariion_qm_anchor_t *anchor_ptr, void *entry_ptr )
...
clariion_qm_remove ( clariion_qm_anchor_t *anchor_ptr, void * entry_ptr )
{
	...
	anchor_ptr->size -= 1;
	removed_links_ptr = CLARIION_QM_ENTRY_PTR_TO_LINK_PTR( anchor_ptr, entry_ptr );
	if( removed_links_ptr->prev == NULL ) {
		prev_links_ptr = &anchor_ptr->links;
	}
	else {
