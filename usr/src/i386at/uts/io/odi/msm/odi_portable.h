#ifndef _IO_MSM_ODI_PORTABLE_H	/* wrapper symbol for kernel use */
#define _IO_MSM_ODI_PORTABLE_H	/* subject to change without notice */

#ident	"@(#)kern-i386at:io/odi/msm/odi_portable.h	1.1"
#ident	"$Header$"
