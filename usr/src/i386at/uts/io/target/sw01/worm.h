#ifndef _IO_TARGET_SW01_WORM_H	/* wrapper symbol for kernel use */
#define _IO_TARGET_SW01_WORM_H	/* subject to change without notice */

#ident	"@(#)kern-pdi:io/target/sw01/worm.h	1.6"
#ident  "$Header$"
