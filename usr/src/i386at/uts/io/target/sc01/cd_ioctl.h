#ifndef _IO_TARGET_SC01_CD_IOCTL_H	/* wrapper symbol for kernel use */
#define _IO_TARGET_SC01_CD_IOCTL_H	/* subject to change without notice */

#ident	"@(#)kern-pdi:io/target/sc01/cd_ioctl.h	1.8"
#ident	"$Header$"
...
#endif /* _IO_TARGET_SC01_CD_IOCTL_H */
