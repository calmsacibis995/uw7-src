...
#	Changes for results file handling. Compatible by default.
#
#	Add support for TET_EXTENDED=T/F handling
...
tet_output(){
	...
	awk 'END {
		...
		"tet_stderr=$TET_STDERR" /dev/null >> ${TET_JOURNAL_PATH}
