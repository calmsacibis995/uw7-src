 ...
 * documentation, and that the name of OSF, SunSoft, Inc., UI or X/Open 
 * not be used in advertising or publicity pertaining to distribution of 
 * the software without specific, written prior permission. OSF, SunSoft, Inc., 
 ...
 * FITNESS, IN NO  EVENT SHALL OSF, SunSoft, Inc., UI or X/Open BE LIABLE 
...
MODIFICATIONS:
	       ...
	       Update Revision number to 1.10.2
	       Andrew Josey, UNIX System Labs Inc., 1st Nov 1993

	       Update Revision number to 1.10.3
	       Andrew Josey, Novell UNIX System Labs Inc., March 1994
************************************************************************/
...
#define TET_VERSION        "1.10.3" /* The version number of the TET */
