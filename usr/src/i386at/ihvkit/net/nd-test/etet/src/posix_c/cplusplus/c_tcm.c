 ...
 * Copyright 1990 Unix International (UI, USL)
 ...
 * documentation, and that the name of OSF, UI, USL or X/Open not be used in 
 * advertising or publicity pertaining to distribution of the software 
 * without specific, written prior permission.  OSF, UI, USL and X/Open make 
 * no representations about the suitability of this software for any purpose.  
 * It is provided "as is" without express or implied warranty.
 *
 * OSF, UI, USL and X/Open DISCLAIM ALL WARRANTIES WITH REGARD TO THIS 
 * SOFTWARE INCLUDING ALL IMPLIED WARRANTIES OF MERCHANTABILITY AND FITNESS, 
 * IN NO EVENT SHALL OSF, UI, USL or X/Open BE LIABLE FOR ANY SPECIAL, 
...
MODIFICATIONS:
	...
	Andrew Josey, UNIX System Labs, May 1993
		Change main to tet_cmain() for C++ binding
		for ETET revision

	Ranjan Das-Gupta, UNIX System Labs Inc, 1 Jul 1993
	 	Code review cleanup 

	Andrew Josey, Novell UNIX System Labs Inc, 16 Feb 1994
	 	Take version number from tcc_env.h TET_VERSION
		rather than have the value hard-coded.
************************************************************************/
