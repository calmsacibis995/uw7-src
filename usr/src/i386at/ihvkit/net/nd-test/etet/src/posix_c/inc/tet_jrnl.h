 ...
 * the software without specific, written prior permission.  OSF, 
 * SunSoft, Inc., UI and X/Open make no representations about the 
...
MODIFICATIONS:
	       ...
	       Add support for TET_JNL_UNAME
	       ETET extension, SunSoft Inc. 1993
