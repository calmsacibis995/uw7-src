# Sample for SunOS 5.x (Solaris 2)
#
...
# For SunOS 4.x
#STD_SIGNALS = 1 2 3 4 6 8 13 14 15 30 31 18 21 22

# For SunOS 5.x
STD_SIGNALS = 1 2 3 4 6 8 13 14 15 16 17 26 27 28
