...
MODIFICATIONS:
		...
		Addition of ETET support
		SunSoft Inc. 1993.

		Addition of tetsuite_root_set flag
		Andrew Josey, UNIX System Labs, May 1993

		Addition of extern char zeetime[]; so that
		calls to get_time() put the time into data that is
		accessible by other modules
		Andrew Josey, UNIX System Labs, 16 May 1993

		Addition of extern char *etet_extended_mode to allow
		runtime switching of journal temporary results file modes.
		Andrew Josey, UNIX System Labs, 27 May 1993

		Code review cleanup  - also includes fixes to TET bug
		reports tet1.10.062 and tet1.10.064.
		Ranjan Das-Gupta, UNIX System Labs, 1 Jul 1993
		...
		Based on proposals 1 and 2 of (tetworks 397) API compliance 
		& TC name passing (William Turnbow)
...
extern    int       etet_ext_set;
extern    char      temp_dir[];
extern    char      temp_base_dir[];
extern    char      tet_root[];
extern    char      tet_suite_root[];
extern    int       tetsuite_root_set;
...
extern    int       oc_set;
extern    int       tet_api_compliant;
extern    int       pass_tc_name_to_tool;
extern    int       eip_set;
...
extern    int       tet_run_set;
extern	  int	    tet_lock_set;

/* end of ETET extensions */
...
extern    void      parse_tprs_list(int);
