/* static char sccsid[] = "@(#)tet_api.h 1.3 92/12/17 "  SMI; */
/*
...
#ifdef SunOS41
#define EXIT_SUCCESS    0       /* in stdlib.h on 5.x */ 
#define EXIT_FAILURE    1       /* in stdlib.h on 5.x */
#endif 
