...
#
#     o Module id is the module as described above.
#     o Messagecat is the name of the message catalog. It should follow the
#       SCO message catalog location and naming conventions.  More than one
...
SCO_AUDIOCONFIGOSA	audioconfig.osa.cat@audio 1
